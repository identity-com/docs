...
Try it out at [cryptid.identity.com](https://cryptid.identity.com/) or install the [cli](https://github.com/identity-com/cryptid/tree/main/cli).

## Screengrabs

### Balances

![Balances Screen](screen_balances.png)

### ID Overview

![Balances Screen](screen_idoverview.png)
...
[Cryptid Signer program](https://github.com/identity-com/cryptid/tree/main/programs/cryptid_signer) is the authority for it which makes sure that only keys and/or
...
To contribute to Cryptid, please check out the [code of conduct](https://github.com/identity-com/cryptid/blob/main/CODE_OF_CONDUCT.md).
...
required by the [CLI](#cli) and [Wallet UI](#wallet).
...
CLI usage instructions can be found in the [readme](https://github.com/identity-com/cryptid/blob/main/cli/README.md).
...
the [Cryptid program](https://github.com/identity-com/cryptid/tree/main/programs/cryptid_signer)
